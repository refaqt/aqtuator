...
Usage:
    python -m measurement_tools.verify_index [--index modules/flexure-ball-screw-servo-stage/measurement/data-index.csv]
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--index", type=Path, default=Path("modules/flexure-ball-screw-servo-stage/measurement/data-index.csv"))
