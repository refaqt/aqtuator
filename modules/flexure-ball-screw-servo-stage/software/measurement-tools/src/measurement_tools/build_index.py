"""Build modules/flexure-ball-screw-servo-stage/measurement/data-index.csv from a measurement data tree.

Raw measurement data lives outside Git (see modules/flexure-ball-screw-servo-stage/measurement/README.md). This tool
